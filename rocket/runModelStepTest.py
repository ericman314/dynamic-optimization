...
if m.options.IMODE == 5:
	...
	print('pointingAuthority = '+str(m.pointingAuthority.value))
	print('liftAuthority = '+str(m.liftAuthority.value[0]))
	print('dragAuthority = '+str(m.dragAuthority.value[0]))
	print('gimbalAuthority = '+str(m.gimbalAuthority.value[0]))
	print('gridAuthority = '+str(m.gridAuthority.value[0]))
