...
plt.legend()
plt.subplot(2, 3, 5)
plt.plot(mpc.time, mpc.θ_x, 'r-', label='theta_x')
plt.plot(mpc.time, mpc.θ_y, 'b-', label='theta_y')
plt.plot(mpc.time, mpc.w_x, 'r.', label='w_x')
plt.plot(mpc.time, mpc.w_y, 'b.', label='w_y')
plt.legend()
plt.subplot(2, 3, 6)
plt.plot(mpc.time, mpc.Gridx, 'r-', label='Gridx')
plt.plot(mpc.time, mpc.Gridy, 'b-', label='Gridy')
plt.legend()
