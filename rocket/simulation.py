...
class MyApp(ShowBase):
  ...
  def myExitFunc(self):
    ...
    plt.subplot(2, 2, 1)
    plt.plot(self.pltTime, self.pltX, label='x')
    plt.plot(self.pltTime, self.pltY, label='y')
    plt.plot(self.pltTime, self.pltZ, label='z')
    plt.legend()
    plt.subplot(2, 2, 2)
    plt.plot(self.pltTime, self.pltXdot, label='vx')
    plt.plot(self.pltTime, self.pltYdot, label='vy')
    plt.plot(self.pltTime, self.pltZdot, label='vz')
    plt.legend()
    plt.subplot(2, 2, 3)
    plt.plot(self.pltTime, self.pltYaw, label='Yaw')
    plt.plot(self.pltTime, self.pltPitch, label='Pitch')
    plt.plot(self.pltTime, self.pltMvYaw, label='MV_Yaw')
    plt.plot(self.pltTime, self.pltMvPitch, label='MV_Pitch')
